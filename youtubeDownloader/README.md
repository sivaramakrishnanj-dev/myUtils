...
Phase 2 — Design in progress. `01-overview.md` **resolved** at `aceca50`; `02-architecture.md` in draft; ADRs 0001–0004 to follow. Phase 1 — Requirements **resolved** (1a `1481921`; 1b `d300785`; 1c `41eefc0`). Code has not started.
