...
| 2 — Design | `01`–`05`, ADRs | in progress (`01-overview.md` **resolved** at `aceca50`; `02-architecture.md` **resolved** at `ec90ff8`; ADRs 0001–0004 **Accepted**; `03-data-model.md` **resolved** at `5a418a1`; `04-apis.md` next) |
